...
class TopupAjax
{
    ...
    public static function handle_validate(): void
    {
        try {
            ...
            CLogger::log('AJAX validate exception', [
    ...
    private static function resolve_wcpa_fields(int $product_id, array $form_fields): array
    {
        ...
        try {
            ...
            CLogger::log('resolve_wcpa_fields exception', [
                'message' => $e->getMessage(),
                'trace'   => $e->getTraceAsString()
            ]);
            return $result;
    ...
    private static function find_account_fields(array $form_fields, array $resolved_fields): array
    {
        ...
        try {
            ...
            CLogger::log('find_account_fields exception', [
                'message' => $e->getMessage(),
                'trace'   => $e->getTraceAsString()
            ]);
            return [
    ...
    /**
     * AJAX: Add product to WooCommerce cart after validation.
     *
     * Reads posted data, ensures product + validation exist,
     * resolves fields, and attempts WC()->cart->add_to_cart().
     */
