...
//
//             if (mode === 'success') {
//                 $icon.html('<i class="fa-solid fa-circle-check"></i>').addClass('success').removeClass('error');
//                 $title.text('Account Validated');
//                 $body.html(`<p>User: <strong>${data.userAccount}</strong></p>
//                             <p>Zone: <strong>${data.zoneId}</strong></p>`);
//             } else {
//                 $icon.html('<i class="fa-solid fa-circle-xmark"></i>').addClass('error').removeClass('success');
//                 $title.text('Validation Failed');
//                 $body.html(`<p>${data.message || 'We could not validate this account.'}</p>`);
//             }
//
//             // Continue handler
//             $modal.find('.xshop-confirm').off('click').on('click', function () {
